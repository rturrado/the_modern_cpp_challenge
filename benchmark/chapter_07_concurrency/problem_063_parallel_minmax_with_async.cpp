...
void cb_parallel_minmax_with_async() {
    ...
    cb_parallel_minmax(
        [](auto first, auto last, auto thread_pool_size, auto block_size) {
            return tmcppc::algorithm::async::parallel_min(first, last, thread_pool_size, block_size);
        },
        [](auto first, auto last, auto thread_pool_size, auto block_size) {
            return tmcppc::algorithm::async::parallel_max(first, last, thread_pool_size, block_size);
        }
    );
}
