...
inline std::ostream& operator<<(std::ostream& os, const discount& d) {
    d.print(os);
    return os;
}
...
struct fmt::formatter<discount> {
    ...
    auto format(const discount& d, FormatContext& ctx) const -> decltype(ctx.out()) {
...
// Discounts
//
inline void print(std::ostream& os, const std::vector<std::shared_ptr<discount>>& discounts, const indentation& indentation = {}) {
    if (discounts.empty()) {
...
struct article {
    ...
    void print(std::ostream& os, const indentation& indentation = {}) const noexcept {
        ...
        fmt::print(os, "{}id : {},\n", indentation + 1, id);
        fmt::print(os, "{}price : {},\n", indentation + 1, price);
        ::print(os, discounts, indentation + 1);
        fmt::print(os, "\n{})", indentation);
    }
};
...
struct fmt::formatter<article> {
    ...
    template <typename FormatContext>
    auto format(const article& a, FormatContext& ctx) const -> decltype(ctx.out()) {
        std::ostringstream oss{};
        a.print(oss);
        return fmt::format_to(ctx.out(), "{}", oss.str());
    }
...
struct store {
    ...
    void print(std::ostream& os, const indentation& indentation = {}) const noexcept {
        fmt::print(os, "{}store[\n", indentation);
        ::print(os, articles, indentation + 1);
        fmt::print(os, "\n{}]", indentation);
    }
};
...
struct fmt::formatter<store> {
    ...
    template <typename FormatContext>
    auto format(const store& s, FormatContext& ctx) const -> decltype(ctx.out()) {
        std::ostringstream oss{};
        s.print(oss);
        return fmt::format_to(ctx.out(), "{}", oss.str());
    }
...
struct fmt::formatter<customer> {
    ...
    template <typename FormatContext>
    auto format(const customer& c, FormatContext& ctx) const -> decltype(ctx.out()) {
        std::ostringstream oss{};
        c.print(oss);
        return fmt::format_to(ctx.out(), "{}", oss.str());
    }
...
struct fmt::formatter<order_line> {
    ...
    template <typename FormatContext>
    auto format(const order_line& order_line, FormatContext& ctx) const -> decltype(ctx.out()) {
        std::ostringstream oss{};
...
struct order {
    ...
    void print(std::ostream& os, const indentation& indentation = {}) const noexcept {
        fmt::print(os, "{}order(\n", indentation);
        fmt::print(os, "{}id : {},\n", indentation + 1, id);
        ::print(os, order_lines, indentation + 1);
        fmt::print(os, ",\n");
...
struct fmt::formatter<order> {
    ...
    template <typename FormatContext>
    auto format(const order& order, FormatContext& ctx) const -> decltype(ctx.out()) {
        std::ostringstream oss{};
        order.print(oss);
        return fmt::format_to(ctx.out(), "{}", oss.str());
    }
