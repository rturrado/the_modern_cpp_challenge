...
TEST(ipv4_string_constructor, DISABLED_abc) { EXPECT_THROW(ipv4{ std::string{ "abc" } }, invalid_ipv4_address_error); }
TEST(ipv4_string_constructor, DISABLED_n_127_0_0_999) { EXPECT_THROW(ipv4{ std::string{ "127.0.0.999" } }, invalid_ipv4_address_error); }

TEST(ipv4_char_star_constructor, DISABLED_abc) { EXPECT_THROW(ipv4{ "abc" }, invalid_ipv4_address_error); }
TEST(ipv4_char_star_constructor, DISABLED_n_127_0_0_999) { EXPECT_THROW(ipv4{ "abc" }, invalid_ipv4_address_error); }
...
TEST(ipv4, DISABLED_equals) { EXPECT_EQ(ipv4{ "127.0.0.1" }, ipv4{ 0x7f'00'00'01 }); }
TEST(ipv4_less_than, DISABLED_ok) { EXPECT_TRUE(ipv4{ "1.1.1.1" } < ipv4{ "1.2.1.1" }); }
TEST(ipv4_less_than, DISABLED_error) { EXPECT_FALSE(ipv4{ "1.1.1.1" } < ipv4{ "1.1.1.1" }); }
