...
TEST(get_longest_collatz_sequence_v1, DISABLED_n_10) { EXPECT_THAT(get_longest_collatz_sequence_v1(10), ::testing::Pair(9, 20)); }
TEST(get_longest_collatz_sequence_v1, DISABLED_n_1_000_000) { EXPECT_THAT(get_longest_collatz_sequence_v1(1'000'000),
    ::testing::Pair(837'799, 525)); }

TEST(get_longest_collatz_sequence_v2, DISABLED_n_0) { EXPECT_THAT(get_longest_collatz_sequence_v2(0), ::testing::Pair(0, 0)); }
TEST(get_longest_collatz_sequence_v2, DISABLED_n_10) { EXPECT_THAT(get_longest_collatz_sequence_v2(10), ::testing::Pair(9, 20)); }
TEST(get_longest_collatz_sequence_v2, DISABLED_n_1_000_000) { EXPECT_THAT(get_longest_collatz_sequence_v2(1'000'000),
    ::testing::Pair(837'799, 525));
}

TEST(problem_12_main, DISABLED_n_1_000_000) {
