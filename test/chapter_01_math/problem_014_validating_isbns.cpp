...
TEST(read_n_digit_isbn, DISABLED_valid_input_with_spaces) {
    std::istringstream iss{ "0 1234 5678 9\n" };
    std::ostringstream oss{};
    EXPECT_EQ(read_n_digit_isbn(iss, oss, 10), "0123456789");
}

TEST(read_n_digit_isbn, DISABLED_valid_input_with_hyphens_and_spaces) {
...
TEST(validate_10_digit_isbn, DISABLED_n_0123456789) { EXPECT_TRUE(validate_10_digit_isbn("0123456789")); }
TEST(validate_10_digit_isbn, DISABLED_n_2123456802) { EXPECT_TRUE(validate_10_digit_isbn("2123456802")); }
TEST(validate_10_digit_isbn, DISABLED_n_0123456780) { EXPECT_FALSE(validate_10_digit_isbn("0123456780")); }
TEST(validate_10_digit_isbn, DISABLED_n_2123456803) { EXPECT_FALSE(validate_10_digit_isbn("2123456803")); }


TEST(validate_13_digit_isbn, DISABLED_n_0123456789012) { EXPECT_TRUE(validate_13_digit_isbn("0123456789012")); }
TEST(validate_13_digit_isbn, DISABLED_n_9782123456803) { EXPECT_TRUE(validate_13_digit_isbn("9782123456803")); }
TEST(validate_13_digit_isbn, DISABLED_n_0123456789013) { EXPECT_FALSE(validate_13_digit_isbn("0123456789013")); }
TEST(validate_13_digit_isbn, DISABLED_n_9782123456804) { EXPECT_FALSE(validate_13_digit_isbn("9782123456804")); }


TEST(problem_14_main, DISABLED_n_0123456789_n_0123456789012) {
    std::istringstream iss{ "0123456789\n0123456780\n0123456789012\n0123456789013\n" };
    std::ostringstream oss{};
