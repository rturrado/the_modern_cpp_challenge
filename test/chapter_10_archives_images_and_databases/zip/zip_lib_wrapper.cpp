...
TEST(zip_compress, DISABLED_input_path_does_not_exist) {
...
TEST(zip_decompress, DISABLED_zip_file_path_does_not_exist) {
    std::ostringstream oss{};
...
TEST(zip_decompress, DISABLED_output_root_path_does_not_exist) {
    std::ostringstream oss{};
...
TEST(zip_compress_decompress, DISABLED_non_empty_folder) {
    std::ostringstream oss{};
