...
TEST(create_png_file_path, DISABLED_file_stem_has_no_extension) {
...
TEST(create_png_file_path, DISABLED_file_stem_has_txt_extension) {
    auto file_root_path{ fs::temp_directory_path() };
...
TEST(create_png_file_path, DISABLED_file_stem_has_png_extension) {
    auto file_root_path{ fs::temp_directory_path() };
