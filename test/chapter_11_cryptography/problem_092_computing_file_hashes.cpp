...
TEST(get_hash_as_hex_string, sha1_of_calibri_ttf) {
...
TEST(get_hash_as_hex_string, sha256_of_calibri_ttf) {
    const auto input_file_path{ tmcppc::env::get_instance().get_resource_folder_path() / "fonts" / "calibri.ttf" };
