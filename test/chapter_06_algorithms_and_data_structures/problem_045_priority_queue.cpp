...
TEST(problem_45_main, DISABLED_output) {
    ...
    EXPECT_THAT(oss.str(), ::testing::HasSubstr("tmcppc::priority_queue<int> pq_1(cbegin(v), cend(v));\n"));
    EXPECT_THAT(oss.str(), ::testing::HasSubstr("tmcppc::priority_queue<int, std::greater<int>> pq_2(cbegin(v), cend(v));\n"));
    EXPECT_THAT(oss.str(), ::testing::HasSubstr("tmcppc::priority_queue<int> pq_3();\n\tpq_3: []\n"));
    EXPECT_THAT(oss.str(), ::testing::HasSubstr("tmcppc::priority_queue<int> pq_5(std::move(pq_1));\n"));
    ...
    EXPECT_THAT(oss.str(), ::testing::HasSubstr("tmcppc::priority_queue<int, std::greater<int>> pq_6();\n\tpq_6: []\n"));
