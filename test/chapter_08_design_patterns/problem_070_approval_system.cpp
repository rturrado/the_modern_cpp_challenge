...
TEST(regular_employee_with_no_direct_manager, approve_expense_0) {
    employee re{ "RE", std::make_unique<regular_employee>() };
    auto ex{ re.approve_expense(0, "ex_1") };
    EXPECT_EQ(ex.approved_by_, "RE");
}
TEST(regular_employee_with_no_direct_manager, approve_expense_1_000) {
    employee re{ "RE", std::make_unique<regular_employee>() };
    auto ex{ re.approve_expense(1'000, "ex_2") };
    EXPECT_EQ(ex.approved_by_, "RE");
}
TEST(regular_employee_with_team_manager_as_direct_manager, approve_expense_2_000) {
    employee re{ "RE", std::make_unique<regular_employee>() };
...
TEST(team_manager_with_no_direct_manager, approve_expense_10_000) {
    employee tm{ "TM", std::make_unique<team_manager>() };
    auto ex{ tm.approve_expense(10'000, "ex_4") };
    EXPECT_EQ(ex.approved_by_, "TM");
}
TEST(team_manager_with_no_direct_manager, approve_expense_20_000) {
    employee tm{ "TM", std::make_unique<team_manager>() };
    auto ex{ tm.approve_expense(20'000, "ex_5") };
    EXPECT_FALSE(ex.approved_by_);
}
TEST(team_manager_with_department_manager_as_direct_manager, approve_expense_20_000) {
    employee tm{ "TM", std::make_unique<team_manager>() };
...
TEST(department_manager_with_no_direct_manager, approve_expense_100_000) {
    employee dm{ "DM", std::make_unique<department_manager>() };
    auto ex{ dm.approve_expense(100'000, "ex_7") };
    EXPECT_EQ(ex.approved_by_, "DM");
}
TEST(department_manager_with_no_direct_manager, approve_expense_200_000) {
    employee dm{ "DM", std::make_unique<department_manager>() };
    auto ex{ dm.approve_expense(200'000, "ex_8") };
    EXPECT_FALSE(ex.approved_by_);
}
TEST(department_manager_with_president_as_direct_manager, approve_expense_200_000) {
    employee dm{ "DM", std::make_unique<department_manager>() };
...
TEST(president_with_no_direct_manager, approve_expense_200_000) {
